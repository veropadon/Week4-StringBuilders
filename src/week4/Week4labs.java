...
public static void main(String[] args) {
	...
	System.out.println(sb.toString());
				...
				//		b. Add 5 Strings to it, each with a different length
	               List<String> strings =  Arrays.asList("Tali" , "Sammy" , "Paul", "I" , "Me and you") ;
				...
				// 			input set that start with the character parameter.
	               Set<String> startsWithH = findAllStartWith(set, 'H');
	               for(String world : startsWithH) {
				...
				// 			is a word and the value is the definition of the word
	               ...
	               dictionary.put("Banana" , "A yellow fruit which you people before eating");
	               dictionary.put("Java", "A programming language created in 1995 and still heavily use today");
			...
			// Method 10:
             public static Set<String> findAllStartWith(Set<String> set, char c ) {
